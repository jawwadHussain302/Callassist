...
def main():
    ...
    if not win_exe_path.exists():
        ...
        try:
            ...
            windows_release_url = "https://github.com/ggerganov/whisper.cpp/releases/download/v1.5.1/whisper-v1.5.1-win.zip"
            ...
            if not found_exe:
                raise Exception("Could not find whisper.exe in the downloaded package")
